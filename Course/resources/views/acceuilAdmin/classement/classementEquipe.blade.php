                                    ...
                                    <div class="col-lg-6 col-md-6 col-6 col-sm-6">
                                        <div class="card-body p-0">
                                            <div class="table-responsive">
                                                <a class="btn btn-outline-danger" href="{{url('pdf')}}"> Exporter Pdf </a>
                                                <table class="table mb-0">
                                                    ...
                                                    @php
                                                        $rangCounts = [];
                                                        foreach ($res as $globals) {
                                                            if (!isset($rangCounts[$globals->rank])) {
                                                                $rangCounts[$globals->rank] = 0;
                                                            }
                                                            $rangCounts[$globals->rank]++;
                                                        }
                                                    ...
                                                    @foreach($res as $globals)
                                                          ...
                                                          @endphp
                                                           <tr>
                                                                ...
                                                                <td style="width: 150px; color:{{ $textColor}}">{{ $globals->total_pts }}</td>
                                                          </tr>
                                                    @endforeach
{{--                                                    @for($i = 0;$i<count($res);$i++)--}}
{{--                                                        <tr>--}}
{{--                                                            @if($res[$i]->rank == ($res[$i]->rank+1))--}}
{{--                                                            <th class="bg-primary" scope="row">{{$res[$i]->rank}} </th>--}}
