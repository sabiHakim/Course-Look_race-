                                ...
                                <form class="row g-3 needs-validation"  action="{{ route('traitLogin') }} "method="post">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            <input type="text" name="name" class="form-control" id="yourUsername" required value="{{ $a->login }}">
                                        </div>
                                    </div>
                                    @error('name')
                                    ...
                                    <div class="col-12">
                                        <div class="input-group has-validation">
                                            ...
                                            <input type="password" name="mdp" class="form-control" id="yourUsername" required value="{{ $a->pwd }}">
                                        </div>
                                    </div>
                                    @error('mdp')
                                    <div class=" mt-2 alert alert-danger">{{ $message }}</div>
